	...
	<div class="formWrapper">
		<form id="resetPasswordForm">
			...
			<div class="inputblock">
				...
				<input id="emnail" name="email" type="email" autocomplete="email" required placeholder="Enter your email" onkeydown="if(event.key === 'Enter'){event.preventDefault();passwordResetRequest();}"/>
			</div>
			<br>
